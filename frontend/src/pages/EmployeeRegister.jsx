    ...
    return (
        ...
        <div className="container mx-auto flex-grow flex items-center justify-center py-12 px-4">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <h2 className="text-3xl font-bold text-[#1A5F7A]">Create Employee Account</h2>
                </div>
                ...
                <div className="flex justify-between">
                    <div className="space-y-2">
                    <Label htmlFor="email">Employee Govt. ID</Label>
                    <Input 
                    id="e_gov_id" 
                    type="text" 
                    placeholder="ABXXX5676XXX" 
                    required 
                    value={formData.e_gov_id}
                    onChange={handleChange}
                    />
                </div>
                ...
                <p className="text-gray-600">
                    ...
                    <Link to="/employeelogin" className="text-[#1A5F7A] hover:underline">
                    Login
                    </Link>
                </p>
                </div>
